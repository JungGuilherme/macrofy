...
import { Loader2, FileText, ExternalLink, Upload, Code, PenLine } from 'lucide-react';
...
export function ArticleForm({
  ...
  useEffect(() => {
    if (article) {
      ...
      setContentMode(isFullHtmlDocument(art.content_html) ? 'raw' : 'rich');
    } else {
      form.reset({
        title: '',
        subtitle: '',
              ...
              {contentMode === 'rich' ? (
                ...
                <div className="space-y-2 rounded-lg border border-border p-3">
                  <p className="text-xs text-muted-foreground">
                    Cole aqui um documento HTML completo (com &lt;style&gt; e &lt;script&gt; próprios) ou
                    carregue o arquivo .html direto. Ele é exibido com fidelidade total.
                  </p>
                  <input
                    type="file"
